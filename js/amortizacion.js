...
btnCalcular.addEventListener('click', () => {
    ...
    switch (modalidad.value) {
        case  "1" :
             calcularCuotaAmortizaciónVencidas(Number(monto.value), Number(tasa.value), Number(tiempo.value), seguro.value);
        break;
...
function calcularCuotaAmortizaciónVencidas(monto, tasa, tiempo, seguro){
